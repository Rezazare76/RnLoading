    ...
    <View style={styles.container} >
      ...
      <View style={styles.loadingContainer}>
        ...
        <FontAwesome
                ...
                size={25}
                color='blue'
                style={{ position:'absolute',top:'45px',right:'-2px',transform:[{rotate:'113deg'}],color:'#079082' }}
              />
              <FontAwesome
                name="plane"
                size={25}
                color='blue'
                style={{ position:'absolute',left:'0px',bottom:'45px',transform:[{rotate:'289deg'}],color:'#079082' }}
              />
       </View>
      </Animated.View>
